...
<div class="flex items-center">
  <img src="{{ asset('img/simtoeic0.png') }}" alt="Sim TOEIC Logo" class="h-10">
            ...
            <div class="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#about" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium transition-colors">About Us</a>
              <a href="#campus" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium transition-colors">Campus</a>
              <a href="#faq" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium transition-colors">FAQ</a>
            </div>
            </div>
            <!-- CTA Button -->
            <div class="flex items-center space-x-4">
            <a href="{{ route('auth.login') }}" class="px-6 py-2 rounded-full text-sm font-medium text-white transition-all duration-300 hover:scale-105" style="background-color: #857bdb; hover:background-color: #6d63b5;">Log In</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden pb-4">
          <div class="flex flex-col space-y-2">
            ...
            <a href="#about" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium">About Us</a>
            <a href="#campus" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium">Campus</a>
            <a href="#faq" class="text-gray-600 hover:text-primary px-3 py-2 text-sm font-medium">FAQ</a>
          </div>
        </div>
      </nav>
    </header>
    ...
    <!-- Hero Section -->
    <!-- Hero Section -->
    <section id="home" class="relative bg-gradient-to-br from-blue-50 to-yellow-50 overflow-hidden py-12">
      <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center px-4">
        <!-- Left Content -->
        ...
        <!-- Main Heading -->
        <div class="space-y-4">
          <h1 class="text-3xl md:text-5xl font-bold text-gray-900 leading-tight gsap-fade">
          Make your TOEIC<br />
          Management Better in<br />
          <span style="color: #8c7cd4;">SIMTOEIC</span>
          </h1>
          <p class="text-base md:text-lg text-gray-600 max-w-md gsap-fade">
        ...
        <div class="relative flex flex-col items-center space-y-6">
          <!-- Animated Info Card 1 -->
          <div class="relative bg-white rounded-2xl shadow-lg px-6 py-4 flex items-center gap-4 w-72 gsap-float hover:scale-105 transition-transform duration-300">
          ...
          <path d="M12 12V4l9 5-9 5-9-5 9-5z" />
            ...
            <div>
              <div class="font-bold text-gray-900">Daily Updates</div>
              <div class="text-xs text-gray-500">Get daily Updates for your TOEIC preparation!</div>
            </div>
          </div>
          <!-- Animated Info Card 2 -->
          <div class="relative bg-white rounded-2xl shadow-lg px-6 py-4 flex items-center gap-4 w-72 gsap-float delay-500 hover:scale-105 transition-transform duration-300">
            <div class="bg-secondary/10 p-3 rounded-full">
              <svg class="h-7 w-7 text-secondary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <path d="M8 12l2 2 4-4" />
            ...
            <div>
              ...
              <div class="text-xs text-gray-500">See top scorers to motivate you!</div>
            </div>
          </div>
          <!-- Animated Info Card 3 -->
          <div class="relative bg-white rounded-2xl shadow-lg px-6 py-4 flex items-center gap-4 w-72 gsap-float delay-1000 hover:scale-105 transition-transform duration-300">
          ...
          <path d="M17 20h5v-2a4 4 0 0 0-3-3.87M9 20H4v-2a4 4 0 0 1 3-3.87m9-4A4 4 0 1 0 7 9a4 4 0 0 0 8 0z" />
              </svg>
            </div>
            <div>
              <div class="font-bold text-gray-900">High Respond Admin</div>
              <div class="text-xs text-gray-500">Get help from our quick respond admin!</div>
            </div>
          </div>
          <!-- Decorative Animated Dots -->
          <div class="absolute -top-4 -right-4 w-4 h-4 bg-primary rounded-full gsap-ping"></div>
          <div class="absolute -bottom-4 left-10 w-3 h-3 bg-secondary rounded-full gsap-ping delay-700"></div>
        </div>
            </div>
          </section>
...
<section id="about" class="py-16 bg-white">
  ...
  <div class="text-center mb-12">
    ...
    <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4 gsap-fade flex items-center justify-center gap-2" style="flex-wrap: wrap;">
      Meet Our Passionate
      <span class="relative inline-block shine-text align-middle" style="color:#857bdb;">
        Team
...
<section id="campus" class="py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div id="dropdown-campus1" class="mt-4 hidden overflow-hidden" style="height:0;">
      ...
      <div id="dropdown-campus2" class="mt-4 hidden overflow-hidden" style="height:0;">
      ...
      <div id="dropdown-campus3" class="mt-4 hidden overflow-hidden" style="height:0;">
      ...
      <div id="dropdown-campus4" class="mt-4 hidden overflow-hidden" style="height:0;">
