@empty($student)
    ...
    @else
    <form action="{{ url('/manage-users/student/' . $student->student_id.'/update_ajax') }}" method="POST" id="form-edit" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="home_address" id="home_address" class="form-control" value="{{ $student->home_address }}" required>
                        <small id="error-home_address" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Current Address</label>
                        <input type="text" name="current_address" id="current_address" class="form-control" value="{{ $student->current_address }}" required>
