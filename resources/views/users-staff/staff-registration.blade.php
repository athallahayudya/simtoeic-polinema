    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 style="font-size: 21px;">Exam Registration</h1>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    @if(isset($staff->photo) && $staff->photo)
                                        <img src="{{ asset($staff->photo) }}" alt="Profile"
                                    ...
                                    @else
                                        <div class="avatar-item mr-3 bg-primary text-white"
                                            ...
                                            <span style="font-size: 24px;">{{ substr($staff->name ?? 'U', 0, 1) }}</span>
                                        </div>
                                    @endif
                                    <div>
                                        <h5 class="mb-0">{{ $staff->name ?? 'User' }}</h5>
                                    </div>
                                </div>
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">Staff ID card and registration confirmation</p>
                                        </div>
                                    </li>
                                    <li class="list-group-item d-flex align-items-center">
                                        <i class="fas fa-check-circle text-success mr-3"></i>
