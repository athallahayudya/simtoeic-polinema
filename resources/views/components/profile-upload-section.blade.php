    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            @if($userVar->ktp_scan)
                ...
                <div class="mt-2">
                    <a href="{{ asset($userVar->ktp_scan) }}" target="_blank" class="btn btn-sm btn-info">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <small class="form-text text-muted">
                <i class="fas fa-info-circle"></i> 
                Supported formats: JPG, JPEG, PNG. Maximum size: 5MB.
                <br>Please ensure the {{ $userType === 'student' ? 'KTM' : 'ID card' }} is clear and all text is readable.
            </small>
            
            @if($userVar->ktm_scan)
                <div class="alert alert-info mt-2">
                    <i class="fas fa-check-circle"></i> Current {{ $userType === 'student' ? 'KTM' : 'ID card' }} uploaded. You can upload a new one to replace it.
                </div>
                <div class="mt-2">
                    <a href="{{ asset($userVar->ktm_scan) }}" target="_blank" class="btn btn-sm btn-info">
            ...
            <div class="document-preview mt-2" id="ktm-scan-container" style="display:none">
                ...
                <img src="" alt="{{ $userType === 'student' ? 'KTM' : 'ID Card' }} Preview" class="img-fluid" id="ktm-scan-preview">
            </div>
