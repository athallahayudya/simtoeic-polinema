<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ url('dashboard-ecommerce-dashboard') }}">simtoeic-polinema</a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ url('dashboard-ecommerce-dashboard') }}">StP</a>
        </div>
        <ul class="sidebar-menu">
            <li class="{{ Request::is('dashboard-ecommerce-dashboard') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('dashboard-ecommerce-dashboard') }}"><i class="fas fa-fire"></i><span>Dashboard</span></a>
            </li>
            <li class="menu-header">Starter</li>
            <li class="{{ Request::is('layout-default-layout') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('layout-default-layout') }}"><i class="fas fa-columns"></i> <span>Layout</span></a>
            </li>
